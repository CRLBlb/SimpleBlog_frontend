      ...
      <div>
        <el-form label-width="80px" size="small" label-position="right">
          ...
          <el-form-item label="博客内容*">
            <mavon-editor v-model="newBlog.content" ref=md @imgAdd="$imgAdd" @change="bindChange"></mavon-editor>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
          <el-button size="mini" type="primary" @click="submit">提交</el-button>
          <el-button size="mini" type="warning" @click="myclear">重置</el-button>
        </div>
      </div>
    </el-card>
  </div>
...
export default {
  ...
  methods: {
    ...
    bindChange(value, render){
      this.newBlog.content = value
      this.newBlog.htmlContent = render
    },
    $imgAdd(pos, $file) {
